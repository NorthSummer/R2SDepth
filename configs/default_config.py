...
########################################################################################################################
cfg.checkpoint = CN()
cfg.checkpoint.filepath = '/data1/lijianing/code/spike/packnet-sfm/ckpt/'            # Checkpoint filepath to save data
...
########################################################################################################################
cfg.save = CN()
cfg.save.folder = '/data1/lijianing/code/spike/packnet-sfm/save/'                    # Folder where data will be saved
cfg.save.depth = CN()
...
cfg.model.params.min_depth = 0.1          # Minimum depth value to evaluate
...
cfg.model.loss._lr_prob = 0.0               # Probablity of horizontal pping
